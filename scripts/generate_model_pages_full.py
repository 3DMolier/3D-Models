...
<link rel="stylesheet" href="/3D-Models/assets/css/critical-fonts.css?v={VERSION}">
<link rel="stylesheet" href="/3D-Models/assets/css/styles.min.css?v={VERSION}">
<link rel="stylesheet" href="/3D-Models/assets/css/model-pages.min.css?v={VERSION}">
<link rel="stylesheet" href="/3D-Models/assets/css/fonts.css?v={VERSION}">
...
<div class="mp-bc-bar">
  <div class="max-w-7xl mx-auto px-6 py-3 mp-bc-inner">
    ...
    <a href="/3D-Models/full-catalog/" class="mp-bc-link">Full Catalog</a>
    <span class="mp-bc-sep">&#8250;</span>
    ...
    <div class="mp-hero-grid">
      ...
      <div class="mp-info-col">
        <div class="mp-badge-row">
          <a href="/3D-Models/full-catalog/" class="chip chip-teal chip--sm">3D Models</a>
          {cert_badge}
        </div>
        ...
        <div class="mp-ctas">
          ...
          <a href="/3D-Models/full-catalog/" class="btn-ghost mp-btn-browse">
            Browse Full Catalog
          </a>
        </div>
      </div>
...
<footer class="mp-footer">
  <div class="max-w-7xl mx-auto">
    <div class="mp-footer-bottom">
      ...
      <a href="/3D-Models/full-catalog/" class="nav-link mp-back-link">&#8592; Full Catalog</a>
    </div>
  </div>
</footer>
<script src="/3D-Models/assets/js/site.min.js?v={VERSION}" defer></script>
</body>
</html>'''
