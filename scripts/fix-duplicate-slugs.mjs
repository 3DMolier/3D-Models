 ...
 *
 * Какой адрес оставляем. Тот, на который ведут внутренние ссылки: на дефисные
 * варианты их 36 и 25, на слитные - по одной. Слитный вариант становится
 * перенаправлением по образцу остальных 34 тысяч заглушек сайта.
 *
...
const PAIRS = [
  ['electric-scooter1-1428089', 'electric-scooter-1-1428089'],
  ['generic-pickup-21-1096820', 'generic-pickup-2-1-1096820'],
  ['ipad-pro-2020-129-inch-silver-1562907', 'ipad-pro-2020-12-9-inch-silver-1562907'],
];
